  ...
  return (
    <div className="mt-5 p-3 md:p-6 border rounded-lg shadow-md" style={{ direction: "rtl" }}>
      ...
      <div className="flex flex-col md:flex-row sm:flex-col  items-center gap-4 mb-4">
        <input
          type="text"
          placeholder="ابحث عن وصف الدورة الانتخابية..."
          value={searchInput}
        ...
        <button
          ...
          className="bg-blue-600 w-40 text-white px-4 py-2 rounded hover:bg-blue-700 transition"
        >
          بحث
        </button>
      </div>
      ...
      <div className="overflow-x-auto">
        {/* ✅ تمرير searchTerm وليس searchInput */}
        <ElectoralcyclesTabel searchTerm={searchTerm} filterStatus={filterStatus} />
      </div>
    </div>
  );
};

export default Electoralcycles;
